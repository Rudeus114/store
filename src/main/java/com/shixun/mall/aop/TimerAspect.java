...
public class TimerAspect {
    ...
    //切入点表达式解析
    // 第一个*表示不关注方法返回值
    //第二个* com.shixun.mall.service.impl.* 表示包下的哪个实现类也不关注
    //第三个* 表示哪个方法名字也不关注
    //第四个(..)表示哪个方法中的参数列表也不关注
    //"execution(* com.shixun.mall.service.*.*(..))"
    @Around("execution(* com.shixun.mall.service.impl.*.*(..))")
